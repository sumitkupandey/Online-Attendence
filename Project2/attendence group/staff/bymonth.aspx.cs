...
public partial class attendence_group_staff_bymonth : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string month = dropmonth.SelectedItem.ToString();
        string year = dropyear.SelectedItem.ToString();
        show.Text = month + " / " + year;
        con.Open();
        OleDbDataAdapter adp = new OleDbDataAdapter("select * from attendencesheet where course='" + course + "' and sem='" + sem + "' and subject='" + sub + "' and mm='" +month + "' and yy='"+year+"' order by classdate", con);
        DataSet ds = new DataSet();
