<%@ Page Title="" Language="C#" MasterPageFile="~/staffmaster.master" AutoEventWireup="true" CodeFile="bydate.aspx.cs" Inherits="attendence_group_admin_bysubject" %>
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtdate" CssClass="auto-style18" ErrorMessage="Plz Select Date" ForeColor="Red">*</asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td class="auto-style16" colspan="2">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" OnRowDataBound="Page_Load">
